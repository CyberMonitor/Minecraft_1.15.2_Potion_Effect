...
public final class ModBlocks {
	...
	public static final RegistryObject<Block> MY_BLOCK = BLOCKS.register("my_block", () -> new MyBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(0.5F,0.5F).lightValue(13)));
	public static final RegistryObject<Block> ENDER_BLOCK = BLOCKS.register("ender_block", () -> new EnderBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(0.5F,0.5F).lightValue(13)));
	public static final RegistryObject<Block> COMPRESS_COBBLESTONE_BLOCK = BLOCKS.register("compress_cobblestone_block", () -> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F,3.0F)));
